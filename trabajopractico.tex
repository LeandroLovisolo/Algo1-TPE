...
\hspace*{10mm}if\hspace*{1mm}p1\hspace*{1mm}\neq\hspace*{1mm}a\hspace*{1mm}then\hspace*{1mm} p2\hspace*{1mm}==\hspace*{1mm}p1\hspace*{1mm}else\newline \hspace*{15mm}atletaIgualConNacionalidadCambiada(p2, p1, p)}
...
\aux{rankingIgualConAtletletaCambiado}{compNueva, compVieja:Competencia, a: Atleta, nacio: Pais}{Bool} { \newline
	...
	\hspace*{5mm}	if\hspace*{1mm}(ranking(compVieja)[y] \neq a)\hspace*{1mm}then \newline
