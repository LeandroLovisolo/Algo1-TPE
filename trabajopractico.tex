...
\aux{rankingIgualConAtletletaCambiado}{compNueva, compVieja:Competencia, a: Atleta, nacio: Pais}{Bool} { \newline
	...
	\hspace*{5mm}	if (ranking(compVieja)[y] != a) then \newline
	\hspace*{10mm}		ranking(compNueva)[y] == ranking(compVieja)[y] \newline
	\hspace*{5mm}	else \newline
	\hspace*{10mm}		atletaIgualConNacionalidadCambiada(ranking(compNueva))[y], ranking(compVieja)[y], pais)
}
