...
\hspace*{10mm}if\hspace*{1mm}p1\hspace*{1mm}!=\hspace*{1mm}a\hspace*{1mm}then\hspace*{1mm} p2\hspace*{1mm}==\hspace*{1mm}p1\hspace*{1mm}else\newline \hspace*{15mm}atletaIgualConNacionalidadCambiada(p2, p1, p)}
...
\aux{rankingIgualConAtletletaCambiado}{compNueva, compVieja:Competencia, a: Atleta, nacio: Pais}{Bool} { \newline
	...
	\hspace*{5mm}	if\hspace*{1mm}(ranking(compVieja)[y] != a)\hspace*{1mm}then \newline
	\hspace*{10mm}		ranking(compNueva)[y] == ranking(compVieja)[y] \newline
	\hspace*{5mm}	else \newline
	\hspace*{10mm}		atletaIgualConNacionalidadCambiada(ranking(compNueva))[y], ranking(compVieja)[y], nacio)
}
...
\begin{problema}{transcurrirDia}{j: JJOO}{}
	...
	\asegura[menosDel5PorcientoPositivo]{\newline
		100*|distintos([atle \hspace{1mm} | compe \leftarrow listaDeCompetenciasConCat(j, listaDeCategoriasNoFinalizadasDeCompetencias\newline Viejas(pre(j))),\newline 
		atle \leftarrow lesTocoControlAntiDoping(compe), leDioPositivo(compe, atle)])| \leq \newline
		5* |distintos([atle \hspace{1mm} | compe \leftarrow listaDeCompetenciasConCat(j, listaDeCategoriasNoFinalizadasDeCompetencias\newline Viejas(pre(j))),\newline
