...
%aux atletaIgualConNacionalidadCambiada(atNuevo, atViejo: Atleta, nacion:Pais): bool =
%	(ciaNumber(atNuevo) == ciaNumber(atViejo)) &&
%	(nombre(atNuevo) == nombre(atViejo)) &&
%	(sexo(atNuevo) == sexo(atViejo)) &&
%	(añoNacimiento(atNuevo) == añoNacimiento(atViejo)) &&
%	(deportes(atNuevo) == deportes(atViejo)) &&
%	(nacionalidad(atNuevo) == nacion) &&
%	(V d<-deportes(atNuevo))
%		capacidad(atNuevo, d) == capacidad(atViejo, d)
%}	
