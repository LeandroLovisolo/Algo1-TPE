...
\hspace*{5mm}(\forall p1 \leftarrow participantes(c1))\newline
\hspace*{10mm}(\exists p2\leftarrow participantes(c2))\newline
\hspace*{15mm}if p1 != a then p2 == p1 else\newline \hspace*{20mm}atletaIgualConNacionalidadCambiada(p2, p1, p)}

\aux{lesTocoControlAntiDopingIgualEnCompetencias}{c1, c2: Competencia}{bool}{\newline
(|lesTocoControlAntiDoping(c1)| == |lesTocoControlAntidoping(c2)|) \land ((\forall a1 \leftarrow lesTocoControlAntiDoping(c1))\newline
(\exists a2 \leftarrow lesTocoControlAntiDoping(c2)) ciaNumber(a1) == ciaNumber(a2))}
