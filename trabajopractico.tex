...
\begin{problema}{transcurrirDia}{j: JJOO}{}
	...
	\asegura[menosDel5PorcientoPositivo]{\newline
		100*|distintos([atle \hspace{1mm} | compe \leftarrow listaDeCompetenciasConCat(j, catListasEnDiaNoFinalizadas(pre(j))),\newline 
		atle \leftarrow lesTocoControlAntiDoping(compe), leDioPositivo(compe, atle)])| \leq \newline
		5* |distintos([atle \hspace{1mm} | compe \leftarrow listaDeCompetenciasConCat(j, catListasEnDiaNoFinalizadas(pre(j))),\newline
